  ...
  $(document).ready(function () {
    ...
    sync1
      .owlCarousel({
        ...
        navText: [
          "<i class='owl-prev-icon owl-button-icons'></i>",
          "<i class='owl-next-icon owl-button-icons'></i>",
        ],
      })
    ...
    if ($(".menu-items-list").length) {
      ...
      var $grid = $(".menu-items-list").isotope({
      ...
      $("#contactform").validate({
        submitHandler: function (form) {
          ...
          Email.send({
            ...
            Username: "la.estacion.catorce@gmail.com",
            Password: "442484869B27275CC1DD4EA5A4BC3254FAA3",
            To: [
              "la.estacion.catorce@gmail.com",          
              "laestacion142021@gmail.com",
            ],
            // To: "icontsac.web@gmail.com",
            From: "la.estacion.catorce@gmail.com",
            Subject: "Formulario web La Estación 14",
            Body:
            ...
            .then((message) => {
              ...
              var frm = document.querySelector("#contactform").reset();
            })
